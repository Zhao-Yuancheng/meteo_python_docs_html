...
.. "gallery\plot_basics\plot_functions.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_basics_plot_functions.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_basics_plot_functions.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    兰州站近 7 日最高气温（华氏）: ['64.4', '69.8', '75.2', '78.8', '73.4', '68.0', '62.6']
    逐日有效积温（℃·日）: [8.0, 11.0, 14.0, 16.0, 13.0, 10.0, 7.0]
    逐日分级: ['温暖', '温暖', '温暖', '高温', '温暖', '温暖', '温暖']
    最高气温统计: 最低 17.0℃，最高 26.0℃，平均 21.3℃
    7 日平均气温: 15.0℃，7 日有效积温合计: 79.0 ℃·日
...
.. image-sg:: /gallery/plot_basics/images/sphx_glr_plot_functions_001.png
   :alt: 兰州站近 7 日气温与热量（函数化处理流程）
   :srcset: /gallery/plot_basics/images/sphx_glr_plot_functions_001.png
...
.. _sphx_glr_download_gallery_plot_basics_plot_functions.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_functions.ipynb <plot_functions.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_functions.py <plot_functions.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_functions.zip <plot_functions.zip>`
