...
.. "gallery\plot_viz\plot_temperature_series.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_viz_plot_temperature_series.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_viz_plot_temperature_series.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    年度最热：第 215 天（7 月），29.1 ℃
    年度最冷：第 22 天（1 月），-7.2 ℃
    月均温范围：-4.2 ℃（1 月） ~ 24.7 ℃（7 月）
    年均温：10.4 ℃
...
.. image-sg:: /gallery/plot_viz/images/sphx_glr_plot_temperature_series_001.png
   :alt: 兰州 2024 全年气温综合分析, ① 兰州 2024 逐日平均温：冬冷夏热的年周期, ② 日最高温 vs 日最低温散点（颜色 = 月份）, ③ 全年气温分布直方图（偏态 / 双峰一目了然）
   :srcset: /gallery/plot_viz/images/sphx_glr_plot_temperature_series_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_temperature_series.ipynb <plot_temperature_series.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_temperature_series.py <plot_temperature_series.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_temperature_series.zip <plot_temperature_series.zip>`
